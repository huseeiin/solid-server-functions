...
type WrapFunction<TFn extends (...args: Array<any>) => any> = PrependOverload<
  TFn,
  (
    ...args: Parameters<TFn> extends [h3.HTTPEvent<any> | h3.H3Event<any>, ...infer TArgs]
      ? TArgs
      : Parameters<TFn>
  ) => ReturnType<TFn>
>;
...
export const readBody = createWrapperFunction(h3.readBody) as PrependOverload<
  ...
  WrappedReadBody
>;
type WrappedGetQuery = <T, TEventInput = Exclude<InferEventInput<"query", H3Event, T>, undefined>>(
